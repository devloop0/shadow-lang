...
func[static] bool constrain_val_decl(type env* e, type ast::val_decl* vd, bool u) {
...
func[static] bool constrain_datatyp_repl_decl(type env* e, type ast::datatyp_repl_decl* drd, bool u) {
	...
	if (old_lookup == NULL) {
		type lex::token* first = vector::at(drd->ident, 0) as type lex::token** @;
...
func[static] bool constrain_datatyp_decls(type env* e, type vector::vector* dataty_decls, bool u) {
	type scope orig_scope = e->current_scope;
...
func[static] bool constrain_typ_decls(type env* e, type vector::vector* typ_decls, bool u) {
	type scope orig_scope = e->current_scope;
