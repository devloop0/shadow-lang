...
func[static] bool constrain_binary_exp(type env* e, type ast::exp_binary* eb, type ast::typ* s) {
...
func[static] bool constrain_ident_exp(type env* e, type vector::vector* ident, type ast::typ* s_reconstructed) {
